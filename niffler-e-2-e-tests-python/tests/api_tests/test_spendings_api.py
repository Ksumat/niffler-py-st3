...
class TestSpending:
    ...
    def test_add_spend(self, spends_client, spend_data_for_add, currency,
    ...
    def test_add_spend_without_description(self, spends_client, spend_data_for_add,
                                           delete_category_with_spendings):
        spend_data = {
            "amount": spend_data_for_add.amount,
            "description": "",
    ...
    def test_edit_spend(self, spends_client, spend_data_for_edit, add_spend,
    ...
    def test_delete_spend(self, spends_client, spend_data_for_edit, add_spend):
    ...
    def test_get_spend(self, spends_client, spend_data_for_edit, add_spend):
